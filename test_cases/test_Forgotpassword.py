...
class Test_ForgotPassword:
    ...
    # def test_forgotpassword_verify_otp_for_gmail(self,setup):
    #
    #     self.logger.info("*************** test_forgotpassword_verify_otp_for_gmail started *********************")
    #     self.driver = setup
    #     self.driver.get(self.forgotpasswordpage_url)
    #     self.driver.maximize_window()
    #     time.sleep(3)
    #     self.forgotpassword = Zoomview_Forgotpassword_Page(self.driver)  # Corrected instantiation
    #     self.forgotpassword.enter_forgotpasswordpage_email("tulasiram1706@gmail.com")
    #     self.forgotpassword.click_forgotpasswordpage_submit()
    #     time.sleep(5)
    #
    #     chrome_options = webdriver.ChromeOptions()
    ...
    #     time.sleep(4)
    #
    #     gmail = Gmail_Email(self.driver)
    #     gmail.signup_for_gmail()
    #     time.sleep(5)
